...
## Regression log scores {#sec-regression-log-scores}
...
Let's consider the kernel scores for the Old Faithful eruption data.
...
Let's return to the regression example from @sec-regression-log-scores. We will use the `lookout_prob` function to identify outliers in the residuals.
