...
If the surprisal ranks under $f$ and $f^*$ are equal, this is obviously ok. That should be true for any distribution where $u$ is greater than the largest mode of $f$.
