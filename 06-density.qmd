...
$$
P_i = \int f(u) \mathbb{1}(-\log f(u) > p_i) du.
$$
...
When the sample size $n$ is large enough, a quick estimate of the value of $P_i$ can be obtained 
as the proportion of density scores larger than $p_i$.
