...
Now, `r sum(lookout(of) < 0.05)` anomalies are identified, with four of them having infinite LOO density scores. We can visualize them in an HDR scatterplot, shown in @fig-ofpot2.
