...
$\Delta_i = d_{(i+1)} - d_{(i)}$, for $i=1,\dots,n-1$. We choose $h_*$ to be the diameter corresponding to the largest $\Delta_i$. Then we can define the bandwidth matrix to be
$$
