...
The algorithm has performed poorly on the 1000 N(0,1) observations, identifying 66 of them as anomalous.
...
The `lookout` package also implements this method, but uses the Epanechnikov kernel rather than the Gaussian kernel.
