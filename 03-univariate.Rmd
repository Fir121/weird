...
Benjamin Peirce was a Harvard mathematician in the mid 1800s. In 1852 he proposed a test based on what are now called $z$-scores. His criteria was that any observations with $|z| > c$ should be identified as outliers, where $c$ is such that the probability of 

### Chauvenet's criterion {-}

A very old approach due to the astrophysicist William Cauvenet is to identify any point where 
$$
  z_{max} > 
$$
...
@Thompson1935 proposed a test using extreme $z$-scores, where an observation is considered an anomaly if
$$
\max_i |z_i| > c_\alpha
$$
