...
In this procedure, we fit a Generalized Pareto Distribution to $s_i$ using the POT approach discussed in Section @evt, with the $90^{\text{th}}$ percentile as the threshold.
