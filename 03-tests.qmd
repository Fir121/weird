...
stopifnot(nanomalies$Zscore_robust == c(1, 243, 0, 2, 39, 23))
...
For the $\text{t}_3$ example, there are now `r nanomalies$Zscore_robust[5]` out of `r NROW(t3)` observations falsely identified as anomalous, while for the $\chi^2_4$ example, there are now `r nanomalies$Zscore_robust[6]` out of `r NROW(chisq4)` observations falsely identified as anomalous.
